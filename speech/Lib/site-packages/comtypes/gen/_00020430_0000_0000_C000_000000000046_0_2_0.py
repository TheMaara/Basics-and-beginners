...
__all__ = [ 'OLE_OPTEXCLUSIVE', 'OLE_COLOR', 'OLE_XSIZE_PIXELS',
           'Font', 'LoadPictureConstants', 'FONTSIZE', 'FontEvents',
           'Unchecked', 'IFontEventsDisp', 'IFontDisp', 'StdFont',
           'OLE_CANCELBOOL', 'Checked', 'FONTBOLD', 'FONTITALIC',
           'OLE_XPOS_CONTAINER', 'OLE_HANDLE', 'Monochrome',
           'OLE_XPOS_HIMETRIC', 'IFont', 'IPicture',
           'OLE_XSIZE_HIMETRIC', 'FONTNAME', 'OLE_YPOS_CONTAINER',
           'IPictureDisp', 'Picture', 'StdPicture', 'FONTUNDERSCORE',
           'OLE_YSIZE_PIXELS', 'Color', 'OLE_YSIZE_CONTAINER',
           'VgaColor', 'FONTSTRIKETHROUGH', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YPOS_PIXELS', 'OLE_XSIZE_CONTAINER', 'Gray',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC',
           'OLE_XPOS_PIXELS', 'OLE_TRISTATE', 'Default']
from comtypes import _check_version; _check_version('1.1.11', 1536996502.1671302)
